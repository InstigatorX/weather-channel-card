/* Weather Channel Card v1.2.0 | MIT License */

const weatherChannelEmbeddedBackgrounds = __WEATHER_CHANNEL_EMBEDDED_BACKGROUNDS__;
...
class WeatherChannelCard extends HTMLElement {
  ...
  _background(code, isDay) {
    ...
    const image = customImage || weatherChannelEmbeddedBackgrounds[group];
    ...
    if (image?.startsWith("data:image/jpeg;base64,")) {
      return `${overlay},url("${image}") center/cover no-repeat,${fallback}`;
    }
...
console.info("%c WEATHER-CHANNEL-CARD %c v1.2.0 ", "color:#fff;background:#1261a0;font-weight:700", "color:#1261a0;background:#fff");
